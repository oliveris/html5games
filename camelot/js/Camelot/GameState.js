...
Game.GameState.prototype = {
	...
	create: function() {
	    ...
	    //  Set a flags and trees to occur after 5 seconds
	    timer.loop(5250 - enemyDistance, this.flagsCreate, this);

	    // difficulty timer
	    timer.loop(10000, this.difficultyIncrease, this);
	...
	update: function() {
	    ...
	    // }, null, this);
	    if (this.game.physics.arcade.collide(this.player, this.treeGroup, this.treeHitsPlayer, this.processHandler, this)) {
	        console.log('boom');
	    }
	    if (this.game.physics.arcade.collide(this.player, this.flagGroup, this.flagHitsPlayer, this.processHandler, this)) {
	        console.log('boom');
	    }
	},
	...
	heroCreate: function() {
  	...
  	doFlagsMovement: function() {
		...
		{ 
			this.flagGroup['children'][i].y -= enemyMovement;
		}
  	},
  	...
  	flagsGroupCreate: function() {
    	...
    	this.flagGroup = this.game.add.physicsGroup();
  	},
  	...
  	doTreesMovement: function() {
		...
		{ 
			this.treeGroup['children'][i].y -= enemyMovement;
		}
  	},
  	...
  	treesGroupCreate: function() {
    	...
    	// this.treeGroup.checkCollision.up = false;
    	// this.treeGroup.checkCollision.left = false;
    	// this.treeGroup.checkCollision.right = false;
  	},
	...
	treeHitsPlayer: function(player, tree) {
	    ...
	    this.checkLivesEmpty();
	},

	flagHitsPlayer: function(player, tree) {
